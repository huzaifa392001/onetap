...
@section('title', 'FAQs | OneTapDrive')
@section('content')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="aboutContent contentWrap">
                        ...
                        <p>
                            onetapDrive.com presents a comprehensive set of frequently asked questions that you might
                            need
                            answers for before renting a car in the UAE. No matter if you decide to rent a Kia Picanto,
                            Cadillac Escalade or even a Ferrari 488 in the emirates, the below answers apply. Source:
                            various car rental companies operating in Dubai, Abu Dhabi, Ras Al Khaimah and RTA (Road and
                            Transport Authority) itself. Please feel free to share your suggestions and comments with
                            us.
                        </p>
                        <p>
                            Note: Rental car company, car hire company and car lease company all mean the same. They are
                            used interchangeably for maximum effect.
                        </p>
                        <p>
                            Passport holders of GCC, US, UK, Canada and
                            <a class="colored" href=""> certain other countries can drive </a>
                            on their home country license in the UAE.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="aboutContent contentWrap">
                        <p>
                            Here's a complete <a href="#" class="colored">list of traffic fines and charges by RTA Dubai
                                .</a>
                        </p>
                        <p>
                            The above FAQs are written for those interested in hiring a car in Dubai and are gathered
                            from various sources including our partner car rental companies. However, please ask /
                            confirm the details with the car rental company you deal with or Dubai Road & Transport
                            Authority (RTA) authorities for accurate answers. We will be updating this section on an
                            ongoing basis. If you would like to suggest any additions or corrections to this section,
                            please feel free to email us on info@onetapdrive.com
                            onetapDrive claims no responsibility regarding the authenticity and applicability of the
                            above questions & answers and any loss that you may incur by referring to the above
                            information.</p>
                    </div>
                </div>
            </div>
