...
@section('content')
                                ...
                                <div class="col-md-4">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <p class="card-text">Pro Pack for <span class="text_yellow">1
                                                                month</span> in</p>
                                                    </div>
                                                    <div>
                                                        <p>USD 500</p>
                                                ...
                                                <p><i class="fa fa-caret-right" aria-hidden="true"></i> 10 Car Listings + 10
                                                    Refreshes</p>
                                                <p><i class="fa fa-caret-right" aria-hidden="true"></i> Visible on Web + App
                                                </p>
                                                <p><i class="fa fa-caret-right" aria-hidden="true"></i> Featured Listing</p>
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <p class="card-text">5% VAT</p>
                                                    </div>
                                                    <div>
                                                        <p>USD 25</p>
                                                    </div>
                                                ...
                                                <p class="text-secondary">
                                                    Note: As a Dubai-based business, we work within a financial ecosystem
                                                    that primarily uses Dirham (AED) as the local currency. Charging our
                                                    clients in AED reduces currency conversion fees for both parties as the
                                                    United Arab Emirates dirham is pegged to the US dollar at the exchange
                                                    rate of 1 USD = 3.67 AED.
                                                </p>
                                                <div class="d-flex justify-content-between">
                                                    <div>
                                                        <p class="card-text">Grand Total in AED</p>
                                                    </div>
                                                    <div>
                                                        <h6 class="text_yellow">AED 1927</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="mt-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <p class="card-title"><i class="fa fa-user" aria-hidden="true"></i>&nbsp; HM
                                                    Rentals</p>
                                                <p class="card-title"><i class="fa fa-envelope"
                                                        aria-hidden="true"></i>&nbsp; mdhasnain1070@gmail.com</p>
                                                <p class="card-title"><i class="fa fa-phone" aria-hidden="true"></i>&nbsp;
                                                    +97103174731957</p>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div id="Checkout" class="inline">
                                                ...
                                                <form id="myForm">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input id="CreditCardNumber" class="null card-image form-control"
                                                            type="text"></input>
                                                    </div>
                                                    <div class="expiry-date-group form-group">
                                                        <label for="ExpiryDate">Expiry date</label>
                                                        <input id="ExpiryDate" class="form-control" type="text"
                                                            placeholder="MM / YY" maxlength="7"></input>
                                                    </div>
                                                    <div class="security-code-group form-group">
                                                        <label for="SecurityCode">Security code</label>
                                                        <div class="input-container">
                                                            <input id="SecurityCode" class="form-control"
                                                                type="text"></input>
                                                            <i id="cvc" class="fa fa-question-circle"></i>
                                                        </div>
                                                        <div class="cvc-preview-container two-card hide mt-2">
                                                    ...
                                                    <button id="PayButton" class="btn submit-button mt-3">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var cvcPreviewContainer = document.querySelector('.cvc-preview-container');

            cvc.addEventListener('click', function() {
                if (cvcPreviewContainer.classList.contains('hide')) {
                    cvcPreviewContainer.classList.remove('hide');
                } else {
                    cvcPreviewContainer.classList.add('hide');
                }
            });
        });
