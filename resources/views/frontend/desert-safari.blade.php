    ...
    <div class="desert_safari_wrapper">
        ...
        <section class="desert_safari_bg">
            <div class="content_wrap">
                ...
                <ul>
                    <li>
                        Opt for loose-fitting, breathable clothing to keep cool in the
                        desert heat. Lightweight fabrics such as cotton or linen are
                        ideal.
                    </li>
                    <li>
                        Cover your arms and legs with breathable fabrics to protect
                        against the sun, sand, and insects.
                    </li>
                    <li>
                        Shield yourself from the sun with a wide-brimmed hat, sunscreen,
                        and sunglasses.
                    </li>
                    <li>Opt for closed-toe shoes for foot protection in the desert.</li>
                    <li>
                        Bring a lightweight scarf or shawl for head and face covering
                        during sandstorms.
                    </li>
                    <li>
                        Layer up with a light jacket or sweater for cooler evenings.
                    </li>
                    <li>Leave valuable jewelry at home to avoid loss or damage.</li>
                    <li>
                        Carry a small backpack with essentials and a refillable water
