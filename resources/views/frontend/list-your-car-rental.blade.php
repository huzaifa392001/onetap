...
@section('title','List Your Car on Rent ')
<link
rel="stylesheet"
      ...
      <div class="swiper banner_swiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="banner_content">
              <div class="content_area">
                <h1>LIST YOUR CARS FOR RENT TODAY</h1>
                <p>Empty your parking lot tomorrow!</p>
              </div>
              <img
                src="https://www.oneclickdrive.com//application/views/img/cars-in-parking-lot-web-banner.webp"
                alt=""
              />
            </div>
          </div>
          <div class="swiper-slide">
            <div class="banner_content">
              <div class="content_area">
                <h1>JOIN ONETAP DRIVE CAR RENTAL MARKETPLACE</h1>
                <p>Earn atleast 5x ROI and an empty parking lot!</p>
              </div>
              <img
                src="https://www.oneclickdrive.com//application/views/img/web1.webp"
                alt=""
              />
            </div>
          </div>
          <div class="swiper-slide">
            <div class="banner_content">
              <div class="content_area">
                <h1>GET HIGH-QUALITY LEADS</h1>
                <p>Who are already interested to rent your cars</p>
              </div>
              <img
                src="https://www.oneclickdrive.com//application/views/img/web2.webp"
                alt=""
              />
            </div>
          </div>
          <div class="swiper-slide">
            <div class="banner_content">
              <div class="content_area">
                <h1>SHOWCASE YOUR CAR FLEET</h1>
                <p>In front of 200,000+ Potential Customers</p>
              </div>
              <img
                src="https://www.oneclickdrive.com//application/views/img/car-rental-customers-des.webp"
                alt=""
              />
            </div>
          </div>
