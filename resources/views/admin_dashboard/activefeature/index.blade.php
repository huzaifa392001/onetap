                                ...
                                <table data-order='[[ 0, "desc" ]]' class="display dataTable no-footer" id="basic-1" role="grid"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" tabindex="0" aria-controls="basic-1"
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="basic-1"
                                            aria-label="Details: activate to sort column ascending">Remainig Active Cars Listing</th>
                                    ...
                                    @foreach ($companies as $value)
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="editDelete">
                                                ...
                                                <a href="{{ route('edit-active-lisitng', $value->id) }}"> <button
