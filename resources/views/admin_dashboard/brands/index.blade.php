                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="basic-1"
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="basic-1"
                                                aria-label="Details: activate to sort column ascending">Models</th>
                                                <th class="sorting" tabindex="0" aria-controls="basic-1"
                                    ...
                                    <tbody>
                                        @foreach ($brands as $value)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    {{ $value->brand_models ?? null }}
                                                </td>
                                                <td>
                                                <img src="{{ asset('brands/' .$value->brand_image) }}"
                                                ...
                                                <td class="editDelete">
                                                    <form action="{{ route("brand.destroy", $value->id) }}" method="post">
                                                        ...
                                                        <button class="btn btn-danger btn-xs" type="submit"
                                                            data-original-title="btn btn-danger btn-xs" onclick="return confirm('Are you sure you want to delete brand name?');" >Delete</button></a>
                                                    </form>
