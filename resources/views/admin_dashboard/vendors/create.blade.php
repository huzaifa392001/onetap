            ...
            <div class="card">
                <div class="card-body">
                    <div class="form theme-form">
                        <form id="" action="{{route('vendor-store')}}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="password" placeholder="Retype Password" data-bs-original-title="" title="" name="confirm_password">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div>
                                        ...
                                        <a class="btn btn-danger" href="{{route('vendor-index')}}" data-bs-original-title="" title="">Cancel</a>
                                    </div>
                                </div>
                            </div>
