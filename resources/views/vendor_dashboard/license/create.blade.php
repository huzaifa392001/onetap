            ...
            <div class="card">
                <div class="card-body">
                    <div class="form theme-form">
                        <form id="" action="{{route('brand.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="text" placeholder="Enter Brand Models" data-bs-original-title="" title="" name="brand_models" value="{{old('brand_models')}}" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
